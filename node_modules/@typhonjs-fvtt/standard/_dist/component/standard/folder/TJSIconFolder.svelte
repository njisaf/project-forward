<script>
   ...
   import { toggleDetails }   from '@typhonjs-fvtt/runtime/svelte/action/dom/properties';
   import { applyStyles }     from '@typhonjs-fvtt/runtime/svelte/action/dom/style';

   import {
      isMinimalWritableStore,
      subscribeIgnoreFirst }  from '@typhonjs-fvtt/runtime/svelte/store/util';
   ...
   /** @type {import('@typhonjs-fvtt/runtime/svelte/store/util').MinimalWritable<boolean>} */
