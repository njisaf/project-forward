import * as _runtime_util_a11y from '@typhonjs-fvtt/runtime/util/a11y';
 ...
 * `import { TJSContextMenu } from '@typhonjs-fvtt/standard/application';` The front end for TJSContextMenuImpl processes data and
...
declare namespace TjsContextMenuImpl {
  ...
  export type Props = {
    ...
    /** @type {{ [key: string]: string | null }} */
    styles?: { [key: string]: string | null };
    /** @type {{ duration: number, easing: import('@typhonjs-fvtt/runtime/svelte/easing').EasingFunction }} */
    transitionOptions?: { duration: number; easing: _runtime_svelte_easing.EasingFunction };
    offsetX?: number;
    offsetY?: number;
    /** @type {import('@typhonjs-fvtt/runtime/util/a11y').A11yFocusSource} */
