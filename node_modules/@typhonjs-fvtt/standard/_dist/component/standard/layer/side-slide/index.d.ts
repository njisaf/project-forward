...
declare namespace TjsSideSlideLayer {
  ...
  export type Props = {
     ...
     *    icon: string | import('@typhonjs-fvtt/runtime/svelte/util').TJSSvelte.Config.Embed,
     *    svelte: import('@typhonjs-fvtt/runtime/svelte/util').TJSSvelte.Config.Embed,
     *    title?: string
     * }>)}
     */
    items?: Iterable<{
     ...
     *
     * @type {import('@typhonjs-fvtt/runtime/svelte/easing').EasingReference}
     */
