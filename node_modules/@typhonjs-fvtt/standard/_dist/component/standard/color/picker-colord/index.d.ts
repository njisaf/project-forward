...
import * as _runtime_svelte_store_web_storage from '@typhonjs-fvtt/runtime/svelte/store/web-storage';
import * as _standard_component_folder from '@typhonjs-fvtt/standard/component/folder';
...
declare class AddOnState {
  ...
  /**
   * @param {import('svelte/store').Subscriber<import('@typhonjs-fvtt/standard/component/folder').TJSFolderData[]>} handler -
...
declare class InternalState {
   ...
   * @param {import('../').TJSColordPickerOptions}  options -
   *
   * @param {import('@typhonjs-fvtt/runtime/svelte/store/web-storage').WebStorage}  webStorage - External TJS WebStorage instance.
   */
  constructor(
    color: object | string,
    options: TJSColordPickerOptions,
  ...
  /**
   * @returns {import('@typhonjs-fvtt/runtime/svelte/store/web-storage').WebStorage} Gets associated TJS WebStorage instance.
   */
...
declare class TJSColordPickerSavedColors {
  ...
  /**
   * @returns {import('@typhonjs-fvtt/standard/component/folder').TJSFolderData} The TJSFolderData object to configure the
