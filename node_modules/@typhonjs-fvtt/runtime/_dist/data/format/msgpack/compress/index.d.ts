import * as _runtime_data_compress from '@typhonjs-fvtt/runtime/data/compress';
 ...
 *
 * @param {import('@typhonjs-fvtt/runtime/data/compress').InflateOptions} [opts.inflateOptions] - Inflate options.
 *
 ...
 * @param {object}   [opts] - Optional parameters.
 *
 * @param {import('@typhonjs-fvtt/runtime/data/compress').DeflateOptions} [opts.deflateOptions] - Deflate options.
 *
