import { Key, KeyFields } from '@typhonjs-fvtt/runtime/data/struct/hash/array';
export { Key, KeyFields, getValueFromKey } from '@typhonjs-fvtt/runtime/data/struct/hash/array';
