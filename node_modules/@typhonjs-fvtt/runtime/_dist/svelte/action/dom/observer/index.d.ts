...
import * as _runtime_util_dom_observer from '@typhonjs-fvtt/runtime/util/dom/observer';
 ...
 *
 * @param {import('@typhonjs-fvtt/runtime/util/dom/observer').ResizeObserverData.ResizeTarget} target - A
 *        {@link ResizeObserverManager} target to update with observed width & height changes.
 *
 * @returns {(import('svelte/action').ActionReturn<
 *   import('@typhonjs-fvtt/runtime/util/dom/observer').ResizeObserverData.ResizeTarget
