 ...
 *
 * @param {import('@typhonjs-fvtt/runtime/svelte/store/util').MinimalWritable<boolean>}  storeFocused - Update store for focus
 *        changes.
 *
 * @returns {(import('svelte/action').ActionReturn<
 *    import('@typhonjs-fvtt/runtime/svelte/store/util').MinimalWritable<boolean>
 * >)} Lifecycle functions.
 */
