 ...
 *
 * @param {import('@typhonjs-fvtt/runtime/svelte/store/util').MinimalWritable<number>}   store - A minimal writable store that stores
 *        the element scrollTop.
 *
 * @returns {(import('svelte/action').ActionReturn<
 *    import('@typhonjs-fvtt/runtime/svelte/store/util').MinimalWritable<number>
 * >)} Lifecycle functions.
 */
 ...
 *
 * @param {import('@typhonjs-fvtt/runtime/svelte/store/util').MinimalWritable<boolean>} opts.store - A minimal writable boolean store.
 *
