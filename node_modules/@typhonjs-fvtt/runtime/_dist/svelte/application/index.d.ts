import * as _runtime_util_async from '@typhonjs-fvtt/runtime/util/async';
...
import { A11yFocusSource } from '@typhonjs-fvtt/runtime/util/a11y';
import { EasingReference } from '@typhonjs-fvtt/runtime/svelte/easing';
...
import { TransitionFunction } from '@typhonjs-fvtt/runtime/svelte/transition';
  ...
  implements TJSPosition.Positionable
{
   ...
   *
   * @returns {import('@typhonjs-fvtt/runtime/svelte/store/position').TJSPosition} The TJSPosition instance.
   */
