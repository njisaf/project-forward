...
import * as _runtime_plugin_manager_eventbus from '@typhonjs-fvtt/runtime/plugin/manager/eventbus';
import { Eventbus } from '@typhonjs-fvtt/runtime/plugin/manager/eventbus';
...
declare class PluginEntry {
     ...
     *
     * @param {import('@typhonjs-fvtt/runtime/plugin/manager/eventbus').EventbusProxy}  eventbusProxy - The EventbusProxy associated with the plugin
     ...
     *
     * @param {import('@typhonjs-fvtt/runtime/plugin/manager/eventbus').EventbusProxy} eventbusProxy - EventbusProxy instance to associate.
     */
    set eventbusProxy(eventbusProxy: _runtime_plugin_manager_eventbus.EventbusProxy);
    /**
     * Get associated EventbusProxy.
     *
     * @returns {import('@typhonjs-fvtt/runtime/plugin/manager/eventbus').EventbusProxy} Associated EventbusProxy.
     */
 ...
 * import { Eventbus, EventbusProxy, EventbusSecure } from '@typhonjs-fvtt/runtime/plugin/manager/eventbus';
 *
 * // Consistent bus instances useful for testing and broad accessibility:
 * import { mainEventbus, pluginEventbus, testEventbus } from '@typhonjs-fvtt/runtime/plugin/manager/eventbus/buses';
 * ```
 *
...
declare class PluginManager {
     ...
     *
     * @param {import('@typhonjs-fvtt/runtime/plugin/manager/eventbus').Eventbus} [options.eventbus] - An instance of '@typhonjs-plugin/eventbus'
     ...
     *
     * @returns {import('@typhonjs-fvtt/runtime/plugin/manager/eventbus').EventbusProxy} A proxy for the currently set Eventbus.
     */
     ...
     *
     * @returns {import('@typhonjs-fvtt/runtime/plugin/manager/eventbus').EventbusSecure} A secure wrapper for the currently set Eventbus.
     */
     ...
     *
     * @returns {import('@typhonjs-fvtt/runtime/plugin/manager/eventbus').Eventbus} The associated eventbus.
     */
     ...
     * @param {object}     opts - An options object.
     *
     * @param {import('@typhonjs-fvtt/runtime/plugin/manager/eventbus').Eventbus}   opts.eventbus - The new eventbus to associate.
     *
...
declare class PluginInvokeEvent {
     ...
     *
     * @type {import('@typhonjs-fvtt/runtime/plugin/manager/eventbus').EventbusProxy} - The active EventbusProxy for that particular plugin.
     */
...
declare class PluginInvokeSupport implements PluginSupportImpl {
     ...
     * @param {object}     opts - An options object.
     *
     * @param {import('@typhonjs-fvtt/runtime/plugin/manager/eventbus').Eventbus}   opts.eventbus - The eventbus to disassociate.
     *
     * @param {string}     opts.eventPrepend - The current event prepend.
     */
    destroy({ eventbus, eventPrepend }: {
     ...
     * @param {object}     opts - An options object.
     *
     * @param {import('@typhonjs-fvtt/runtime/plugin/manager/eventbus').Eventbus}   opts.oldEventbus - The old eventbus to disassociate.
     *
     * @param {import('@typhonjs-fvtt/runtime/plugin/manager/eventbus').Eventbus}   opts.newEventbus - The new eventbus to associate.
     *
     * @param {string}     opts.oldPrepend - The old event prepend.
     *
     * @param {string}     opts.newPrepend - The new event prepend.
